...
import karpenko.diploma.soccerquiz.databinding.FragmentMissBinding
...
class MissFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.oneMoreTimeButton.setOnClickListener { v ->
            v.findNavController().navigate(R.id.action_missFragment_to_quizFragment)
        }
    ...
    override fun onStart() {
        super.onStart()
        (activity as AppCompatActivity).supportActionBar?.title = "You`ve miss"
